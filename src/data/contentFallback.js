// Last-known-good content, used only when the CMS API (public_api_cms.md)
// is unreachable AND there is no usable cache — see src/services/cms.js.
// Shape matches the API's `data` payload exactly (camelCase, same field
// names) so components never need to branch on where content came from.
...
const waPhone = "6281312322833";

const FALLBACK_CONTENT = {
  waPhone,
  waLink: `https://api.whatsapp.com/send?phone=${waPhone}&text=${encodeURIComponent("sablon konveksi bandung?")}`,
  ...
  heroSlides: [
    { image: gambar2, alt: "Hasil sablon kaos custom 22Studio" },
    { image: gambar3, alt: "Proses produksi konveksi 22Studio" },
    { image: gambar4, alt: "Kaos custom siap kirim" },
    { image: gambar5, alt: "Detail sablon berkualitas premium" },
    { image: jumbotron, alt: "Workshop 22Studio Bandung" },
  ],
  ...
  clients: [
    ...
    { name: "Lacoste", logo: "https://brandlogos.net/wp-content/uploads/2021/05/lacoste-crocodiles-logo.png" },
  ...
  projects: [
    {
      ...
      image: "https://images.unsplash.com/photo-1529374255404-311a2a4f1fd9?auto=format&fit=crop&w=776&q=80",
    },
    {
      title: "Seragam Perusahaan",
      description: "Polo bordir khusus untuk perusahaan teknologi",
      image: "https://images.unsplash.com/photo-1583743814966-8936f5b7be1a?auto=format&fit=crop&w=774&q=80",
    },
    {
  ...
  steps: [
    ...
    },
    {
      stage: "05",
      title: "Pengiriman",
      description: "Kemeja kustom Anda dikemas dengan hati-hati dan dikirim ke depan pintu Anda atau siap diambil.",
    },
  ],
